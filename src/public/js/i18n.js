...
(function (global) {
  ...
  var D = {
    "pt-BR": {
      ...
      "meta.matches.title": "Ranking | SatorX",
      ...
      "rules.demo.enpassant": "En passant — captura em passagem",
      "rules.demo.promotion": "Promoção — peão vira dama",
      "rules.demo.checkmate": "Xeque-mate — rei sem escape",
      /* abas */
      "rules.tab.moves": "Movimentos",
      "rules.tab.special": "Lances Esp.",
      "rules.tab.attack": "⚔ Ataque",
      "rules.tab.defense": "🛡 Defesa",
      /* lances especiais */
      "rules.demo.castling-k": "Roque pequeno — lado do rei",
      "rules.demo.castling-q": "Roque grande — lado da dama",
      "rules.demo.capture": "Captura — remover a peça adversária",
      "rules.s.castlingTitle": "🏰 Roque",
      "rules.s.castlingDesc": "O único lance em que duas peças se movem ao mesmo tempo: rei e torre. Protege o rei e ativa a torre.",
      "rules.s.castlingK": "Roque pequeno",
      "rules.s.castlingKDesc": ": rei vai para g1, torre salta de h1 para f1.",
      "rules.s.castlingQ": "Roque grande",
      "rules.s.castlingQDesc": ": rei vai para c1, torre salta de a1 para d1.",
      "rules.s.castlingCond": "Condições: ",
      "rules.s.castlingCondList": "rei e torre não se moveram; casas entre eles livres; rei não está em xeque, não passa por casa atacada e não termina em xeque.",
      "rules.s.enpassantTitle": "👻 En Passant",
      "rules.s.enpassantDesc": "Quando um peão adversário avança 2 casas e fica ao lado do seu peão, você o captura movendo-se diagonalmente para a casa que ele \"passou\".",
      "rules.s.enpassantAnim": "Ver animação",
      "rules.s.enpassantCond": "Atenção: ",
      "rules.s.enpassantCondList": "só pode ser feito imediatamente no lance seguinte ao avanço duplo — se jogar outra peça, perde o direito.",
      "rules.s.promotionTitle": "👑 Promoção",
      "rules.s.promotionDesc": "Ao chegar na última fileira, o peão deve ser promovido: escolha Dama, Torre, Bispo ou Cavalo.",
      "rules.s.promotionAnim": "Ver animação",
      "rules.s.promotionNote": "Promover a Cavalo pode criar garfos surpreendentes — chama-se \"sub-promoção\".",
      "rules.s.captureTitle": "💥 Captura",
      "rules.s.captureDesc": "Mover-se para a casa de uma peça adversária remove-a do jogo. Qualquer peça pode ser capturada exceto o rei — se o rei não escapar é xeque-mate.",
      "rules.s.captureAnim": "Ver animação",
      "rules.s.captureNote": "Capturar não é obrigatório — só o xeque exige resposta imediata.",
      /* ataque */
      "rules.demo.fork": "Garfo — cavalo ataca duas peças",
      "rules.demo.pin": "Cravada — peça não pode se mover",
      "rules.demo.skewer": "Espeto — peça valiosa forçada a fugir",
      "rules.demo.discovered": "Ataque descoberto — dois ataques simultâneos",
      "rules.a.forkTitle": "🍴 Garfo (Fork)",
      "rules.a.forkDesc": "Uma peça ataca duas ou mais peças ao mesmo tempo. O cavalo é o mestre do garfo — seu movimento irregular impede o adversário de bloquear ambos os ataques.",
      "rules.a.forkAnim": "Ver animação",
      "rules.a.forkNote": "Garfo + rei = garfo real: o rei deve mover, a outra peça é perdida.",
      "rules.a.pinTitle": "📌 Cravada (Pin)",
      "rules.a.pinDesc": "Peça de longo alcance ataca em linha onde há uma peça adversária na frente de uma mais valiosa. Mover a peça da frente expõe a valiosa atrás.",
      "rules.a.pinAnim": "Ver animação",
      "rules.a.pinNote": "Cravada absoluta: a peça está diante do rei e não pode se mover legalmente.",
      "rules.a.skewerTitle": "🗡 Espeto (Skewer)",
      "rules.a.skewerDesc": "A peça mais valiosa é atacada diretamente e ao escapar expõe a menos valiosa atrás. Forçar o rei a recuar para capturar a torre é um espeto clássico.",
      "rules.a.skewerAnim": "Ver animação",
      "rules.a.discoveredTitle": "💡 Ataque Descoberto",
      "rules.a.discoveredDesc": "Ao mover uma peça, revela-se o ataque de outra peça atrás. A peça que move pode ameaçar algo ao mesmo tempo — dois ataques impossíveis de defender.",
      "rules.a.discoveredAnim": "Ver animação",
      "rules.a.discoveredNote": "Se o ataque descoberto é ao rei, chama-se xeque descoberto — um dos mais perigosos no xadrez.",
      /* defesa */
      "rules.demo.block": "Bloqueio — interpor peça no caminho",
      "rules.demo.escape": "Fuga — rei sai da linha de fogo",
      "rules.demo.exchange": "Troca — capturar o atacante",
      "rules.demo.king-safety": "Segurança — roque cedo protege o rei",
      "rules.d.blockTitle": "🧱 Bloqueio (Interposição)",
      "rules.d.blockDesc": "Ao receber xeque de uma peça de longa distância, interponha uma peça própria no caminho. Só funciona se há pelo menos uma casa entre o atacante e o rei.",
      "rules.d.blockAnim": "Ver animação",
      "rules.d.escapeTitle": "🏃 Fuga do Rei",
      "rules.d.escapeDesc": "Mova o rei para uma casa não atacada. É a resposta mais direta ao xeque. Verifique se a nova casa não é controlada por outra peça adversária.",
      "rules.d.escapeAnim": "Ver animação",
      "rules.d.exchangeTitle": "⚔ Capturar o Atacante",
      "rules.d.exchangeDesc": "Capture a peça que está dando xeque. Elimina a ameaça imediatamente. Analise se a troca é favorável e se não cria novas fraquezas.",
      "rules.d.exchangeAnim": "Ver animação",
      "rules.d.safetyTitle": "🏰 Segurança do Rei",
      "rules.d.safetyDesc": "Realize o roque cedo para proteger o rei atrás de uma muralha de peões. Evite manter o rei no centro durante a abertura.",
      "rules.d.safetyAnim": "Ver animação",
      "rules.d.safetyNote": "Regra de ouro: realize o roque antes do lance 10 sempre que possível.",
      /* abas novas */
      "rules.tab.openings": "♟ Aberturas",
      "rules.tab.tactics2": "⚡ Táticas+",
      "rules.tab.errors": "🔍 Erros",
      /* aberturas */
      "rules.demo.opening-italian": "Italiana — 1.e4 e5 2.Cf3 Cc6 3.Bc4",
      "rules.demo.opening-sicilian": "Siciliana — 1.e4 c5 2.Cf3 d6",
      "rules.demo.opening-gambito": "Gambito da Dama — 1.d4 d5 2.c4",
      "rules.demo.opening-ruy": "Ruy López — 1.e4 e5 2.Cf3 Cc6 3.Bb5",
      "rules.o.italianTitle": "♟ Italiana (1.e4 e5 2.Cf3 Cc6 3.Bc4)",
      "rules.o.italianDesc": "Uma das aberturas mais antigas e populares. Brancas ocupam o centro, desenvolvem cavalo e bispo mirando o ponto f7.",
      "rules.o.italianNote": "Ideia-chave: controle do centro, desenvolvimento rápido, roque antes do lance 8.",
      "rules.o.sicilianTitle": "♟ Siciliana (1.e4 c5)",
      "rules.o.sicilianDesc": "A defesa mais popular contra 1.e4. Pretas criam desequilíbrio imediato — vantagem no flanco da dama enquanto brancas atacam no flanco do rei.",
      "rules.o.sicilianNote": "Usada por Kasparov e Fischer. Produz jogo desequilibrado e criativo.",
      "rules.o.gambitoTitle": "♙ Gambito da Dama (1.d4 d5 2.c4)",
      "rules.o.gambitoDesc": "Brancas oferecem o peão c em troca de controle do centro. Gambito aceito é tecnicamente arriscado para as pretas.",
      "rules.o.gambitoNote": "Repertório de Kasparov, Carlsen e Fischer. Posicional e estratégico.",
      "rules.o.ruyTitle": "♞ Ruy López (1.e4 e5 2.Cf3 Cc6 3.Bb5)",
      "rules.o.ruyDesc": "Uma das mais estudadas. O bispo em b5 pressiona o cavalo que defende e5, indiretamente atacando o centro preto.",
      "rules.o.ruyNote": "Preferida por Kasparov (brancas) e Carlsen (pretas — variante Berlim). Extremamente profunda.",
      "rules.o.animBtn": "Ver sequência",
      /* táticas+ */
      "rules.demo.double-check": "Xeque duplo — dois ataques, só fuga resolve",
      "rules.demo.zugzwang": "Zugzwang — qualquer lance piora a posição",
      "rules.demo.deflection": "Deflexão — forçar o guardião a abandonar seu posto",
      "rules.demo.overload": "Sobrecarga — uma peça defendendo dois alvos",
      "rules.t.doubleCheckTitle": "⚡ Xeque Duplo",
      "rules.t.doubleCheckDesc": "Duas peças dão xeque simultaneamente. O rei não pode responder capturando ou bloqueando — só a fuga é possível.",
      "rules.t.doubleCheckNote": "No xeque duplo é impossível bloquear os dois ataques — o rei sempre deve mover.",
      "rules.t.zugzwangTitle": "♟ Zugzwang",
      "rules.t.zugzwangDesc": "Qualquer lance piora a própria posição. Quem tiver que mover está em desvantagem. Comum em finais de rei e peão.",
      "rules.t.zugzwangNote": "Palavra alemã: \"obrigação de mover\". Dominar o zugzwang é essencial para vencer finais.",
      "rules.t.deflectionTitle": "🔄 Deflexão",
      "rules.t.deflectionDesc": "Força uma peça defensora a abandonar seu posto. Sacrifica-se material para desviar o guardião, permitindo ameaça decisiva.",
      "rules.t.deflectionNote": "Clássico: torre sacrificada afasta a torre defensora, liberando a dama para o mate.",
      "rules.t.overloadTitle": "🔒 Sobrecarga",
      "rules.t.overloadDesc": "Uma peça não consegue defender dois alvos simultaneamente. Ataca-se ambos; ao defender um, o outro é perdido.",
      "rules.t.overloadNote": "Procure peças adversárias que defendam dois ou mais alvos — são candidatas a sobrecarga.",
      "rules.t.animBtn": "Ver animação",
      /* erros */
      "rules.demo.scholars-mate": "Mate do Pastor — armadilha dos 4 lances",
      "rules.demo.hanging": "Peça pendurada — perda gratuita de material",
      "rules.demo.slow-dev": "Desenvolvimento tardio — rei exposto no centro",
      "rules.demo.king-weakness": "Sacrifício Grego Bxh7+ — fraqueza no roque",
      "rules.e.scholarsTitle": "⚠ Xeque-mate do Pastor",
      "rules.e.scholarsDesc": "Armadilha mais famosa para iniciantes. Dama e bispo atacam f7 — ponto mais fraco do rei adversário. Mate em 4 lances se as pretas não souberem defender.",
      "rules.e.scholarsCond": "Defesa: ",
      "rules.e.scholarsCondList": "Cf6 ataca a dama em h5, ou g6 empurra-a de volta. Nunca negligencie ataques à dama adversária.",
      "rules.e.hangingTitle": "💣 Peças Penduradas",
      "rules.e.hangingDesc": "Peça sem defesa é uma peça perdida. Antes de qualquer lance, verifique se alguma peça sua está desprotegida e se o adversário pode capturá-la gratuitamente.",
      "rules.e.hangingNote": "Após jogar, sempre pergunte: minha última jogada deixou alguma peça sem defesa?",
      "rules.e.slowDevTitle": "⏰ Desenvolvimento Tardio",
      "rules.e.slowDevDesc": "Não desenvolver peças rapidamente deixa o rei no centro vulnerável. Enquanto um lado ainda tem peças na 1.ª fileira, o outro já ataca com forças mobilizadas.",
      "rules.e.slowDevNote": "Princípio: desenvolva cavalos e bispos antes de mover a dama ou as torres.",
      "rules.e.kingWeakTitle": "🔥 Fraqueza no Roque (Sacrifício Grego)",
      "rules.e.kingWeakDesc": "Mover peões na frente do rei roquado cria fraquezas. Bxh7+! expõe o rei e leva ao mate com dama e cavalo.",
      "rules.e.kingWeakNote": "Nunca mova h2-h3 ou g2-g3 sem necessidade absoluta no meio-jogo.",
      "rules.e.animBtn": "Ver sequência",
      ...
      "matches.type": "Tipo",
      "matches.typeMultiplayer": "Player vs Player",
      "matches.typeEngine": "IA vs Player",
      "matches.typeHuman": "Player vs Player",
      "matches.elo": "Elo",
      "matches.eloEngine": "Elo ~{elo}",
      "matches.eloPlayer": "Elo ~{player} (vs motor ~{elo})",
      "matches.eloNone": "—",
      "matches.versusEngine": "Você vs Sator Engine",
      "matches.versusHuman": "Brancas vs Pretas",
    ...
    en: {
      ...
      "rules.demo.enpassant": "En passant — capturing in passing",
      "rules.demo.promotion": "Promotion — pawn becomes a queen",
      "rules.demo.checkmate": "Checkmate — the king has no escape",
      /* tabs */
      "rules.tab.moves": "Moves",
      "rules.tab.special": "Special Moves",
      "rules.tab.attack": "⚔ Attack",
      "rules.tab.defense": "🛡 Defense",
      /* special moves */
      "rules.demo.castling-k": "Kingside castling",
      "rules.demo.castling-q": "Queenside castling",
      "rules.demo.capture": "Capture — remove the opponent's piece",
      "rules.s.castlingTitle": "🏰 Castling",
      "rules.s.castlingDesc": "The only move where two pieces move at once: the king and a rook. Protects the king and activates the rook.",
      "rules.s.castlingK": "Kingside castling",
      "rules.s.castlingKDesc": ": king moves to g1, rook jumps from h1 to f1.",
      "rules.s.castlingQ": "Queenside castling",
      "rules.s.castlingQDesc": ": king moves to c1, rook jumps from a1 to d1.",
      "rules.s.castlingCond": "Conditions: ",
      "rules.s.castlingCondList": "king and rook have not moved; squares between them are empty; king is not in check, does not pass through an attacked square, and does not end in check.",
      "rules.s.enpassantTitle": "👻 En Passant",
      "rules.s.enpassantDesc": "When an opponent's pawn advances 2 squares from its start and lands beside your pawn, you can capture it by moving diagonally to the square it \"passed through\".",
      "rules.s.enpassantAnim": "See animation",
      "rules.s.enpassantCond": "Note: ",
      "rules.s.enpassantCondList": "this capture is only available immediately after the double advance — if you play another piece, you lose the right.",
      "rules.s.promotionTitle": "👑 Promotion",
      "rules.s.promotionDesc": "When a pawn reaches the last rank it must be promoted: choose a Queen, Rook, Bishop, or Knight.",
      "rules.s.promotionAnim": "See animation",
      "rules.s.promotionNote": "Promoting to a Knight can create surprising forks — this is called an \"underpromotion\".",
      "rules.s.captureTitle": "💥 Capture",
      "rules.s.captureDesc": "Moving onto a square occupied by an opponent's piece removes it from the game. Any piece can be captured except the king — if the king cannot escape, it is checkmate.",
      "rules.s.captureAnim": "See animation",
      "rules.s.captureNote": "Capturing is not mandatory — only a check requires an immediate response.",
      /* attack */
      "rules.demo.fork": "Fork — one piece attacks two",
      "rules.demo.pin": "Pin — piece cannot move legally",
      "rules.demo.skewer": "Skewer — valuable piece forced to flee",
      "rules.demo.discovered": "Discovered attack — two simultaneous threats",
      "rules.a.forkTitle": "🍴 Fork",
      "rules.a.forkDesc": "One piece attacks two or more opponent's pieces at the same time. The knight is the master of the fork — its irregular movement prevents the opponent from blocking both attacks.",
      "rules.a.forkAnim": "See animation",
      "rules.a.forkNote": "Fork + king = royal fork: the king must move, and the other piece is lost.",
      "rules.a.pinTitle": "📌 Pin",
      "rules.a.pinDesc": "A long-range piece attacks along a line where an opponent's piece sits in front of a more valuable one. Moving the front piece exposes the valuable piece behind.",
      "rules.a.pinAnim": "See animation",
      "rules.a.pinNote": "Absolute pin: the pinned piece is in front of the king and cannot move legally.",
      "rules.a.skewerTitle": "🗡 Skewer",
      "rules.a.skewerDesc": "The opposite of a pin: the most valuable piece is attacked directly and by fleeing exposes a less valuable piece behind it.",
      "rules.a.skewerAnim": "See animation",
      "rules.a.discoveredTitle": "💡 Discovered Attack",
      "rules.a.discoveredDesc": "Moving one piece reveals an attack from another piece behind it. The moving piece can create its own threat at the same time — two attacks that are impossible to defend.",
      "rules.a.discoveredAnim": "See animation",
      "rules.a.discoveredNote": "If the discovered attack targets the king, it is called a discovered check — one of the most dangerous moves in chess.",
      /* defense */
      "rules.demo.block": "Interpose — place a piece in the way",
      "rules.demo.escape": "Escape — king moves out of the line of fire",
      "rules.demo.exchange": "Exchange — capture the attacker",
      "rules.demo.king-safety": "Safety — early castling protects the king",
      "rules.d.blockTitle": "🧱 Interposition (Block)",
      "rules.d.blockDesc": "When in check from a long-range piece, place one of your own pieces in the path to block the attack. Only works if there is at least one square between the attacker and the king.",
      "rules.d.blockAnim": "See animation",
      "rules.d.escapeTitle": "🏃 King Escape",
      "rules.d.escapeDesc": "Move the king to a square that is not under attack. This is the most direct response to check. Make sure the new square is not controlled by another opponent piece.",
      "rules.d.escapeAnim": "See animation",
      "rules.d.exchangeTitle": "⚔ Capture the Attacker",
      "rules.d.exchangeDesc": "Capture the piece giving check. This eliminates the threat immediately. Assess whether the trade is materially favorable and does not create new weaknesses.",
      "rules.d.exchangeAnim": "See animation",
      "rules.d.safetyTitle": "🏰 King Safety",
      "rules.d.safetyDesc": "Castle early to place the king behind a wall of pawns, protecting it from central attacks. Avoid keeping the king in the center during the opening.",
      "rules.d.safetyAnim": "See animation",
      "rules.d.safetyNote": "Golden rule: castle before move 10 whenever possible.",
      /* new tabs */
      "rules.tab.openings": "♟ Openings",
      "rules.tab.tactics2": "⚡ Tactics+",
      "rules.tab.errors": "🔍 Errors",
      /* openings */
      "rules.demo.opening-italian": "Italian Game — 1.e4 e5 2.Nf3 Nc6 3.Bc4",
      "rules.demo.opening-sicilian": "Sicilian Defense — 1.e4 c5 2.Nf3 d6",
      "rules.demo.opening-gambito": "Queen's Gambit — 1.d4 d5 2.c4",
      "rules.demo.opening-ruy": "Ruy López — 1.e4 e5 2.Nf3 Nc6 3.Bb5",
      "rules.o.italianTitle": "♟ Italian Game (1.e4 e5 2.Nf3 Nc6 3.Bc4)",
      "rules.o.italianDesc": "One of the oldest and most popular openings. White occupies the center, develops the knight to f3 and the bishop to c4 targeting the weak f7 point.",
      "rules.o.italianNote": "Key idea: central control, quick development, castle before move 8.",
      "rules.o.sicilianTitle": "♟ Sicilian Defense (1.e4 c5)",
      "rules.o.sicilianDesc": "The most popular defense against 1.e4. Black creates immediate imbalance — queenside counterplay while White attacks on the kingside.",
      "rules.o.sicilianNote": "Used by Kasparov and Fischer. Produces unbalanced, creative play.",
      "rules.o.gambitoTitle": "♙ Queen's Gambit (1.d4 d5 2.c4)",
      "rules.o.gambitoDesc": "White offers the c-pawn in exchange for central control. Accepting the gambit is technically risky for Black.",
      "rules.o.gambitoNote": "Repertoire of Kasparov, Carlsen and Fischer. Positional and strategic.",
      "rules.o.ruyTitle": "♞ Ruy López (1.e4 e5 2.Nf3 Nc6 3.Bb5)",
      "rules.o.ruyDesc": "One of the most studied openings. The bishop on b5 pressures the knight defending e5, indirectly attacking the central pawn.",
      "rules.o.ruyNote": "Preferred by Kasparov (White) and Carlsen (Black — Berlin variation). Extremely deep.",
      "rules.o.animBtn": "See sequence",
      /* tactics+ */
      "rules.demo.double-check": "Double check — two attacks, only flight works",
      "rules.demo.zugzwang": "Zugzwang — any move worsens the position",
      "rules.demo.deflection": "Deflection — force the guardian to abandon its post",
      "rules.demo.overload": "Overload — one piece defending two targets",
      "rules.t.doubleCheckTitle": "⚡ Double Check",
      "rules.t.doubleCheckDesc": "Two pieces give check simultaneously after a discovered check. The king cannot respond by capturing or blocking — only flight works.",
      "rules.t.doubleCheckNote": "It is impossible to block both checks at the same time — the king must always move.",
      "rules.t.zugzwangTitle": "♟ Zugzwang",
      "rules.t.zugzwangDesc": "Any move worsens your own position. The player to move is at a disadvantage. Common in king-and-pawn endgames.",
      "rules.t.zugzwangNote": "German word: 'obligation to move'. Mastering zugzwang is essential for winning pawn endgames.",
      "rules.t.deflectionTitle": "🔄 Deflection",
      "rules.t.deflectionDesc": "Force a defending piece to abandon its post. Material is sacrificed to lure the guardian away, allowing a decisive threat.",
      "rules.t.deflectionNote": "Classic: a rook sacrifice deflects the defending rook, freeing the queen for checkmate.",
      "rules.t.overloadTitle": "🔒 Overloading",
      "rules.t.overloadDesc": "A piece cannot defend two targets simultaneously. Attack both at once; when one is defended, the other falls.",
      "rules.t.overloadNote": "Look for opponent pieces defending two or more targets — they are overloading candidates.",
      "rules.t.animBtn": "See animation",
      /* errors */
      "rules.demo.scholars-mate": "Scholar's Mate — four-move trap",
      "rules.demo.hanging": "Hanging piece — free material loss",
      "rules.demo.slow-dev": "Slow development — king exposed in the center",
      "rules.demo.king-weakness": "Greek Gift Bxh7+ — weakness in the castled position",
      "rules.e.scholarsTitle": "⚠ Scholar's Mate",
      "rules.e.scholarsDesc": "The most famous trap for beginners. The queen and bishop attack f7 — the weakest point near the king. Checkmate in 4 moves if Black does not know the defense.",
      "rules.e.scholarsCond": "Defense: ",
      "rules.e.scholarsCondList": "Nf6 attacks the queen on h5, or g6 drives it back. Never ignore attacks on the opponent's queen.",
      "rules.e.hangingTitle": "💣 Hanging Pieces",
      "rules.e.hangingDesc": "An undefended piece is a lost piece. Before every move, check whether any of your pieces is unprotected and whether the opponent can capture it for free.",
      "rules.e.hangingNote": "After each move, always ask: did my last move leave any piece undefended?",
      "rules.e.slowDevTitle": "⏰ Slow Development",
      "rules.e.slowDevDesc": "Failing to develop pieces quickly leaves the king vulnerable in the center. While one side still has pieces on the first rank, the other attacks with full force.",
      "rules.e.slowDevNote": "Principle: develop knights and bishops before moving the queen or rooks.",
      "rules.e.kingWeakTitle": "🔥 Weakened Castle (Greek Gift)",
      "rules.e.kingWeakDesc": "Moving pawns in front of the castled king creates exploitable weaknesses. Bxh7+! exposes the king and leads to checkmate with queen and knight.",
      "rules.e.kingWeakNote": "Never play h2-h3 or g2-g3 without absolute necessity in the middlegame.",
      "rules.e.animBtn": "See sequence",
      ...
      "matches.type": "Type",
      "matches.typeMultiplayer": "Player vs Player",
      "matches.typeEngine": "AI vs Player",
      "matches.typeHuman": "Player vs Player",
      "matches.elo": "Elo",
      "matches.eloEngine": "Elo ~{elo}",
      "matches.eloPlayer": "Elo ~{player} (vs engine ~{elo})",
      "matches.eloNone": "—",
      "matches.versusEngine": "You vs Sator Engine",
      "matches.versusHuman": "White vs Black",
